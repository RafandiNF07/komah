...
| :--- | :--- | :--- | :--- | :--- |
| **Pemesanan Ojek (Antar/Jemput)** | [ride/page.jsx](app/%28dashboard%29/user/ride/page.jsx) | `OrderMap.jsx`, `MapPicker.jsx` | `orders` | Menginput nama lokasi & titik koordinat peta $\rightarrow$ hitung jarak & harga $\rightarrow$ simpan ke database dengan status `searching`. |
| **Pemesanan Pengiriman (KOMAH Delivery)** | [delivery/page.jsx](app/%28dashboard%29/user/delivery/page.jsx) | `OrderMap.jsx`, `MapPicker.jsx` | `orders` | Menginput detail barang, nomor WA penerima, titik jemput/tujuan $\rightarrow$ kalkulasi tarif $\rightarrow$ simpan pesanan. |
| **Pemesanan Makanan (KOMAH Food)** | [food/page.jsx](app/%28dashboard%29/user/food/page.jsx) | `OrderMap.jsx`, `MapPicker.jsx` | `orders` | Menginput detail makanan/resto $\rightarrow$ pilih lokasi pengantaran $\rightarrow$ simpan pesanan. |
| **Pemesanan Jasa (KOMAH Helper)** | [helper/page.jsx](app/%28dashboard%29/user/helper/page.jsx) | `constants.js` (tarif minimum) | `orders` | Menginput deskripsi tugas jasa/bantuan $\rightarrow$ tarif awal dihitung minimum Rp5.000 (selanjutnya bisa dinego via WA) $\rightarrow$ simpan pesanan. |
| **Riwayat & Cetak Struk (Pelanggan)** | [history/page.jsx](app/%28dashboard%29/user/history/page.jsx) | `lib/pdf.js` (`generateOrderReceipt`) | `orders`, `profiles` | Mengambil data order berdasarkan ID Pelanggan $\rightarrow$ kelompokkan pesanan aktif dan selesai $\rightarrow$ unduh struk pesanan PDF menggunakan jsPDF. |

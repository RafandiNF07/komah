...
export function useProfile() {
  ...
  useEffect(() => {
    ...
    // 1. Muat data dari localStorage secara aman di client setelah ter-mount
    try {
    ...
    // 2. Jalankan fetch pertama kali (silent refresh jika sudah ada cache)
    fetchProfile(hasCache);

    // 3. Dengar perubahan status autentikasi
